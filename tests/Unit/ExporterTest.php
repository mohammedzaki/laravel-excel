...
class ExporterTest extends TestCase
{
    ...
    public function test_can_export_csv()
    {
        ...
        //Export the file
        $exporter = $this->app->make('mohammedzaki/exporter')->make('csv');
    ...
    public function test_can_export_odt()
    {
        ...
        //Export the file
        $exporter = $this->app->make('mohammedzaki/exporter')->make('openoffice');
        $exporter->load(Item::all())->save(self::FILE);
    ...
    public function test_can_export_xlsx()
    {
        ...
        //Export the file
        $exporter = $this->app->make('mohammedzaki/exporter')->make('excel');
        $exporter->load(Item::all())->save(self::FILE);
